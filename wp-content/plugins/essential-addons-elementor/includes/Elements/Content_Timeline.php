							...
							<div class="eael-content-timeline-block">
								...
								<div class="eael-content-timeline-content">
									...
									<?php if( 'yes' == $settings['eael_show_excerpt'] ) : ?>
										<p><?php echo implode(" ", array_slice(explode(" ", strip_tags(strip_shortcodes($custom_content['eael_custom_excerpt']))), 0, $settings['eael_excerpt_length'])) . $settings['excerpt_expanison_indicator']; ?></p>
									<?php endif; ?>
