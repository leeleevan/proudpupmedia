...
class Bootstrap
{
    ...
    private function __construct()
    {
        ...
        add_filter('eael/advanced-data-table/source', [$this, 'advanced_data_table_source']);
        ...
        add_filter('eael/advanced-data-table/table_html/database', [$this, 'advanced_data_table_database_html'], 10, 2);
